...
object Constants {
    ...
    const val MAX_ITERATION = 19
    const val PAGES_TO_FETCH = 2
    const val DAYS_LIMIT = 2

    const val DEFAULT_TRACK_IMAGE_URL = "https://www.wagbet.com/wp-content/uploads/2019/11/music_placeholder.png"
    const val DEFAULT_PLAYLIST_IMAGE_URL = "https://www.wagbet.com/wp-content/uploads/2019/11/music_placeholder.png"
