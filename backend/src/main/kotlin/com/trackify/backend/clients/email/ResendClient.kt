package com.trackify.backend.clients.email
    ...
    fun generateEmailBody(userAddedTracks: List<Track>): String {
        ...
        <body>
            <div class="email-container">
                ...
                <div class="footer">
                    © ${LocalDate.now().year} - Trackify - Desarrollado por <a href="https://github.com/emlopezr" style="color: #1db954; text-decoration: none;">@emlopezr</a>
                </div>
            </div>
        </body>
        </html>
